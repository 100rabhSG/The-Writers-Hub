    ...
    <Paper style={{ padding: '20px', borderRadius: '15px' }} elevation={6}>
      <div className={classes.card}>
        <div className={classes.section}>
          ...
          <Typography gutterBottom variant="h6" color="textSecondary" component="h3">{post.tags.map((tag) => `#${tag} `)}</Typography>
          <br></br>
          ...
          <Typography variant="body1"><strong>{moment(post.createdAt).fromNow()}</strong></Typography>
